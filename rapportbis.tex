...
\subsection{Grammaires de tests}

Voici nos grammaires de tests :

    \inputminted{ocaml}{resultats.ml}
    \caption{Gramamire de tests}
\label{lst:long}

\subsection{Résultats}

\subsubsection{Non terminaux accessibles}

\paragraph{accTest1}

\begin{minted}
val accTest1 : lettre list =
[NT 'D'; NT 'E'; NT 'B'; NT 'A']
\end{minted}

\paragraph{accTest2}
\begin{minted}
val accTest2 : lettre list =
[NT 'F']
\end{minted}

\paragraph{accTest3}
\begin{minted}
val accTest3 : lettre list =
[NT 'B'; NT 'S']
\end{minted}

\paragraph{accTest4}
\begin{minted}
val accTest4 : lettre list =
[NT 'T'; NT 'U']
\end{minted}

\subsubsection{Règles productives}

\paragraph{prodTest1}
\begin{minted}
val prodTest1 : regle list =
  [Prod (NT 'Z', [Epsilon]); Prod (NT 'A', [NT 'B'; T 'c']);
   Prod (NT 'B', [T 'd']); Prod (NT 'F', [T 'g'; T 'a'])]
...
\paragraph{prodTest2}
\begin{minted}
val prodTest2 : regle list =
  [Prod (NT 'S', [T 'a'; NT 'S'; NT 'B'; NT 'S'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'A', [T 'c'; NT 'S']); Prod (NT 'S', [NT 'S']);
   Prod (NT 'B', [NT 'S']); Prod (NT 'B', [Epsilon]);
   Prod (NT 'S', [Epsilon]); Prod (NT 'D', [Epsilon]);
   Prod (NT 'F', [T 'g'; T 'a'])]
...
\paragraph{prodTest3}
\begin{minted}
val prodTest3 : regle list =
  [Prod (NT 'U', [NT 'T'; T 'a'; NT 'U']);
   Prod (NT 'U', [NT 'T'; T 'a'; NT 'T']);
   Prod (NT 'V', [NT 'T'; T 'b'; NT 'V']);
   Prod (NT 'V', [NT 'T'; T 'b'; NT 'T']);
   Prod (NT 'T', [T 'a'; NT 'T'; T 'b'; NT 'T']);
   Prod (NT 'T', [T 'b'; NT 'T'; T 'a'; NT 'T']); Prod (NT 'T', [Epsilon])]

\end{minted}

\paragraph{prodTestEpsilon}
\begin{minted}
val prodTestEpsilon : regle list =
[Prod (NT 'S', [Epsilon])]

\end{minted}

\subsubsection{Non terminaux productifs}

\paragraph{termesProdTest1}
\begin{minted}
val termesProdTest1 : lettre list =
[NT 'A'; NT 'F'; NT 'B'; NT 'Z']
\end{minted}

\paragraph{termesProdTest2}
\begin{minted}
val termesProdTest2 : lettre list =
[NT 'A'; NT 'F'; NT 'D'; NT 'S'; NT 'B']

\end{minted}

\paragraph{termesProdTest3}
\begin{minted}
val termesProdTest3 : lettre list =
[NT 'S'; NT 'V'; NT 'U'; NT 'T']

\end{minted}

\paragraph{termesProdTestEpsilon}
\begin{minted}
val termesProdTestEpsilon : lettre list =
[NT 'S']

\end{minted}


\subsubsection{Suppression des $\epsilon$-regles}

\paragraph{epsTest1}
\begin{minted}
val epsTest1 : regle list =
  [Prod (NT 'A', [NT 'B'; T 'c']); Prod (NT 'B', [T 'c'; T 'c'; NT 'D']);
   Prod (NT 'B', [T 'd']); Prod (NT 'D', [NT 'E']);
   Prod (NT 'F', [T 'g'; T 'a'])]
...
\paragraph{epsTest2}
\begin{minted}
val epsTest2 : regle list =
  [Prod (NT 'A', [T 'c']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'B'; NT 'S'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'B'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'B'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'B'; NT 'S'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; NT 'B'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; NT 'B'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'B'; NT 'S'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'S'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; NT 'S'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; T 'b'; T 'd']);
   Prod (NT 'S', [T 'a'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'S'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'S'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'S', [T 'a'; NT 'S'; NT 'B'; NT 'S'; T 'b'; T 'd'; NT 'S']);
   Prod (NT 'A', [T 'c'; NT 'S']); Prod (NT 'B', [NT 'S']);
   Prod (NT 'D', [NT 'E']); Prod (NT 'F', [T 'g'; T 'a'])]

\end{minted}

\paragraph{epsTest3}
\begin{minted}
val epsTest3 : regle list =
  [Prod (NT 'U', [NT 'T'; T 'a'; NT 'U']);
   Prod (NT 'U', [NT 'T'; T 'a'; NT 'T']);
   Prod (NT 'V', [NT 'T'; T 'b'; NT 'V']);
   Prod (NT 'V', [NT 'T'; T 'b'; NT 'T']);
